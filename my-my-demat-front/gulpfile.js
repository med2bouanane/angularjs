...
/******************************* */
// .add(paths.source + "**/*.ts", paths.referenceTs)
gulp.task("compile-ts2", function () {
    return browserify({
        basedir: '.',
        debug: true,
        entries: ['src/application/typescript/app.module.ts'],
        cache: {},
        packageCache: {}
    })
...
gulp.task("build", ["clean"], function () {
    plugins.runSequence(["check-name-convention", "copy-libs", "copy-translation", "copy-img", "copy-fonts", "copy-external-js"],
        ["compile-ts","compile-ts2", "compile-sass", "copy-main-html"], "jsHint");
});
