module arvato.demat.controller {
     ...
     */
    export class ControlImageTreatmentBaseController {

        static $inject: string[] = ["$location", "$routeParams", "AuthSharedService","ControlImageTreatmentService","TrayService"];
        ...
        constructor(private $location: ng.ILocationService,
                    ...
                    private controlImageService: services.controlimage.ControlImageTreatmentService,
    ...
    app.controller("ControlImageTreatmentBaseController", ControlImageTreatmentBaseController);
}