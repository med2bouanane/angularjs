...
/***/ function(module, exports) {
	...
	function Cropper(options) {
	  ...
	  var defaults = {
	    ...
	    zoomStep: 0.1,
	    actionLabels: {
	      rotateLeft: '<span class=\'glyphicon glyphicon-chevron-left\'></span>',
	      rotateRight: '<span class=\'glyphicon glyphicon-chevron-right\'></span>',
	      zoomIn: '<span class=\'glyphicon glyphicon-plus\'></span>',
	      zoomOut: '<span class=\'glyphicon glyphicon-minus\'></span>',
	      fit: '<span class=\'glyphicon glyphicon-fullscreen\'></span>',
	      crop: '<span class=\'glyphicon glyphicon glyphicon-camera\'></span>'
	    }
	  };
	...
	Cropper.prototype.buildDOM = function() {
	  ...
	  _elements.wrapper.className = 'panel panel-default imgCropper-wrapper';
	
	  // Container.
	  _elements.container = document.createElement('div');
	  _elements.container.className = 'panel-body imgCropper-container';
	  ...
	  _elements.controls.wrapper.className = 'panel-heading imgCropper-controls';
